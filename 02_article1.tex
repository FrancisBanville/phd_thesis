...
\begin{table}[h!]
  ...
  \hline
  \\
  $P(L_{i, j, k} \vert X_{i,k}, X_{j,k},...)$ & local & realization of the interaction given taxa co-occurrence & species distribution models & \cite{Gravel2019Bringing}, \cite{Dansereau2024Spatially}, Boxes~\ref{box2.1} and \ref{box2.5} \\
  \\ 
  ...
  \\
  $P(L_{i, j, k} \vert T_{i,k}, T_{j,k}, ...)$ & local & realization of the interaction given local traits & trait matching models & \cite{Caron2024Traitmatching}, Box~\ref{box2.4} \\
  \\
  ...
  \\
  $P(L_{i, j, k} \vert A_0, ...)$ & local & realization of the interaction in a given area or volume & spatial models & \cite{Galiana2018Spatiala} *, Box~\ref{box2.3} \\ 
  \\
  $P(L_{i, j, k} \vert t_0,...)$ & local & realization of the interaction during a given time period & temporal models & \cite{Weinstein2017Comparing}, Boxes~\ref{box2.1} and \ref{box2.3} \\
  \\
  ...
  \\
  $P(L_{i, j, k} \vert M_{i, j},...)$ & local & realization of the interaction given that it is biologically feasible & spatiotemporal models & \cite{Dansereau2024Spatially}, Boxes~\ref{box2.2}, \ref{box2.3}, and \ref{box2.5} \\
  \\
...
\newtcolorbox{box2.1}{colback=green!10,enhanced,title=Box \customlabel{box2.1}{2.1}: A spatiotemporally explicit model of interactions ,
...
\newtcolorbox{box2.2}{colback=green!10,enhanced,title=Box \customlabel{box2.2}{2.2}: Dissimilarity of local host-parasite networks,
	attach boxed title to top left={xshift=-4mm},boxrule=0pt,after skip=1cm,before skip=1cm,right skip=0cm,breakable,fonttitle=\bfseries,toprule=0pt,bottomrule=0pt,rightrule=0pt,leftrule=4pt,arc=0mm,skin=enhancedlast jigsaw,sharp corners,colframe=gree,colbacktitle=gre,boxed title style={
		frame code={ 
			\fill[gre](frame.south west)--(frame.north west)--(frame.north east)--([xshift=3mm]frame.east)--(frame.south east)--cycle;
			\draw[line width=1mm,gre]([xshift=2mm]frame.north east)--([xshift=5mm]frame.east)--([xshift=2mm]frame.south east);
...
\newtcolorbox{box2.3}{colback=green!10,enhanced,title=Box \customlabel{box2.3}{2.3}: Spatial and temporal scaling of interactions,
	attach boxed title to top left={xshift=-4mm},boxrule=0pt,after skip=1cm,before skip=1cm,right skip=0cm,breakable,fonttitle=\bfseries,toprule=0pt,bottomrule=0pt,rightrule=0pt,leftrule=4pt,arc=0mm,skin=enhancedlast jigsaw,sharp corners,colframe=gree,colbacktitle=gre,boxed title style={
		frame code={ 
			\fill[gre](frame.south west)--(frame.north west)--(frame.north east)--([xshift=3mm]frame.east)--(frame.south east)--cycle;
			\draw[line width=1mm,gre]([xshift=2mm]frame.north east)--([xshift=5mm]frame.east)--([xshift=2mm]frame.south east);
...
\newtcolorbox{box2.4}{colback=green!10,enhanced,title=Box \customlabel{box2.4}{2.4}: Taxonomic scaling of interactions,
	attach boxed title to top left={xshift=-4mm},boxrule=0pt,after skip=1cm,before skip=1cm,right skip=0cm,breakable,fonttitle=\bfseries,toprule=0pt,bottomrule=0pt,rightrule=0pt,leftrule=4pt,arc=0mm,skin=enhancedlast jigsaw,sharp corners,colframe=gree,colbacktitle=gre,boxed title style={
		frame code={ 
			\fill[gre](frame.south west)--(frame.north west)--(frame.north east)--([xshift=3mm]frame.east)--(frame.south east)--cycle;
			\draw[line width=1mm,gre]([xshift=2mm]frame.north east)--([xshift=5mm]frame.east)--([xshift=2mm]frame.south east);
...
\newtcolorbox{box2.5}{colback=green!10,enhanced,title=Box \customlabel{box2.5}{2.5}: Sampling for binary interaction networks,
	attach boxed title to top left={xshift=-4mm},boxrule=0pt,after skip=1cm,before skip=1cm,right skip=0cm,breakable,fonttitle=\bfseries,toprule=0pt,bottomrule=0pt,rightrule=0pt,leftrule=4pt,arc=0mm,skin=enhancedlast jigsaw,sharp corners,colframe=gree,colbacktitle=gre,boxed title style={
		frame code={ 
			\fill[gre](frame.south west)--(frame.north west)--(frame.north east)--([xshift=3mm]frame.east)--(frame.south east)--cycle;
			\draw[line width=1mm,gre]([xshift=2mm]frame.north east)--([xshift=5mm]frame.east)--([xshift=2mm]frame.south east);
