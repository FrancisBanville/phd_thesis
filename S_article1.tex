...
probability of $10\%$. This metaweb was used in Boxes 3 and 5.
...
\section{Additional methods for Box 2: Dissimilarity of local host-parasite networks}
...
j})$ for each curve in Figure 2 (panels c-d) is the probability before
...
\section{Additional methods for Box 3: Spatial and temporal scaling of interactions}
...
\section{Additional methods for Box 5: Sampling for binary interaction networks}
