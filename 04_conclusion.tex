...
d'autres types de réseaux (p. ex. aux réseaux d'interactions hôtes-parasites ou
...
peut toutefois s'appuyer sur des relations allométriques existantes, telle que
la relation entre l'énergie métabolique et la biomasse fournie par la théorie
métabolique de l'écologie (\cite{Brown2004Metabolic}, \cite{West1997General}),
pour estimer les paramètres manquants (tel qu'effectué par
