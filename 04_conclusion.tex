...
déterminants écologiques des interactions entre espèces, décrits dans
...
explicites, elle peut guider nos efforts d'identification des mécanismes
dominants régissant la structure des réseaux trophiques. D'abord, tel
qu'expliqué par \textcite{Harte2014Maximum}, une théorie écologique basée sur le
principe d'entropie maximale tient compte des mécanismes écologiques de manière
implicite par le biais de nos connaissances préalables. En effet, les mécanismes
sous-jacents à la structure des réseaux trophiques sont capturés par la valeur
empirique des variables d'état. Ainsi, pour mieux comprendre les mécanismes qui
déterminent la structure des réseaux trophiques, nous pouvons examiner ceux qui
régissent les variables d'état. Ensuite, les erreurs de prédiction de la théorie
nous informent de la présence de mécanismes importants n'ayant pas été capturés
par les variables d'état. Trophique-METE peut donc être utilisée comme modèle
nul, fournissant des distributions de référence auxquelles la structure des
réseaux empiriques est comparée. À cet égard, les écarts entre la structure des
réseaux empiriques et prédits peuvent fournir des informations écologiques plus
importantes que les mesures brutes. Lorsque ces erreurs sont systématiques
...
sous-jacents. Cependant, Trophique-METE ne peut qu'orienter nos recherches des
mécanismes importants des réseaux trophiques vers ceux régissant les variables
d'état et erreurs de prédiction, sans les identifier directement. Il est donc
nécessaire de mener des études plus approfondies pour mieux cerner et identifier
les mécanismes dominants.


\subsection{Prédire les propriétés des réseaux trophiques dans le temps et l'espace} 
...
meilleure compréhension des milieux naturels et de leurs possibles changements
futurs peut renforcer notre désir de les protéger, y compris face aux menaces
