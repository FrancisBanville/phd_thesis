...
mesure la plus courante en théorie de l'information, et est calculée
...
d'adjacence (obtenues par SVD). Elle quantifie l'information contenue dans le
réseau, c.-à-d. la quantité d'information requise pour encoder le réseau. Une
entropie SVD élevée indique que les vecteurs singuliers (obtenus par SVD)
...
mentionnées plus haut (\cite{Strydom2021Svd}). Elle a été choisie comme mesure
d'entropie de la matrice d'adjacence des réseaux dans les versions de la théorie
de l'entropie maximale des réseaux trophiques développées dans
l'article~\ref{art:article2} de cette thèse. 
