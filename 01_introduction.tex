...
\section{L'écologie des réseaux pour mieux comprendre les écosystèmes complexes (10 pages)}
...
structure émergente des réseaux d'interactions. Ces descriptions permettent de
...
\section{De la nécessité de développer des modèles prédictifs (2 pages)} 
...
\section{Vers une théorie de l'entropie maximale des réseaux trophiques (5 pages)}
...
(see Annex 1), $L$ also scales with habitat area [BrosOstl04]. 
