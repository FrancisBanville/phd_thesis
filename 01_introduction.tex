...
\begin{figure}[h]
    ...
    font également partie d'une communauté plus large d'espèces qui interagissent entre
    elles, formant un réseau trophique d'interactions prédateurs-proies et
    plantes-herbivores. Cette thèse décrit l'incertitude au sein de ces réseaux
    trophiques, notamment la probabilité qu'une interaction entre deux espèces
    se produise localement. En outre, cette thèse montre comment prédire la
    structure émergente des réseaux trophiques lorsque nous avons peu
    d'information sur ces interactions. Crédit photo~: Yves Banville.}
\end{figure}
