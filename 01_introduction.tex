...
(\cite{May1972Will}). Ces mesures sont donc essentielles pour mieux comprendre
les caractéristiques des systèmes écologiques complexes. 
...
Virginie varient localement selon la disponibilité saisonnière en nourriture
...
seule de ces mesures qui capture la complexité physique d'un système (c.-à-d. la
...
versions ont été testées à l'aide de réseaux trophiques échantillonnés à
