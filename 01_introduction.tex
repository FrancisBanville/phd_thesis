...
\section{L'écologie des réseaux pour mieux comprendre les écosystèmes complexes (6 pages)}
...
une décision prise à Toronto peut avoir des répercussions à Londres et à Tokyo
...
modéliser, dans notre quotidien et la nature. 
...
niveau supérieur (\cite{Foote2007Mathematics}). La structure ordonnée des
systèmes complexes émerge donc du désordre des éléments et de leurs
interactions. Le nombre élevé d'interactions et de rétroactions (processus par
lequel les interactions passées influencent celles à venir) dans les systèmes
complexes rend cependant difficile la prédictibilité de leur structure
(\cite{Ladyman2013What}). 
...
des liens entre ces nœuds (\cite{Newman2003Structure}).    
...
\subsection{Qu'est-ce qu'un réseau d'interactions entre espèces?} 
...
\subsection{Pourquoi étudier les réseaux d'interactions entre espèces?} 
