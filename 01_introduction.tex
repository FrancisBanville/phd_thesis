...
Les systèmes complexes sont partout autour de nous. Considérons les transactions
...
en quelques secondes seulement. Pensons également au réseau de neurones dans
notre cerveau (\cite{Sporns2011Human}), qui orchestre des milliers de signaux
électriques à chaque seconde pour créer notre expérience subjective du monde. Ou
...
étudier, dans notre quotidien et la nature. 
...
d'exposer cette théorie, il convient d'examiner certains concepts clés de
l'écologie des réseaux afin de mieux décrire la composition et la représentation
des écosystèmes complexes. Les sous-sections suivantes traitent de la nature et
des mesures des interactions entre espèces et dressent un portrait de la
structure émergente des réseaux d'interactions. Ces descriptions permettront de
mieux comprendre les fondements et domaines d'application de cette théorie en
développement.  
...
\subsubsection{Une interaction peut être représentée à différents niveaux d'organisation} 

Bien que les interactions se produisent biologiquement entre des individus,
elles peuvent être représentées à des niveaux d'organisation supérieures (p.
ex., au niveau de l'espèce). Les individus sont à la base des interactions
écologiques puisque ce sont eux qui effectuent les échanges d'information,
de matière ou d'énergie. Par exemple, c'est du sang d'un cerf de Virginie
...
écologique des espèces et des propriétés émergentes des écosystèmes
(\cite{Loreau2010Populations}, \cite{McCann2011Food},
\cite{Bascompte2013Mutualistic}, \cite{Delmas2019Analysing},
\cite{Gonzalez2020Scalingup}), tout en formant la plupart des réseaux
d'interactions échantillonnés (\cite{Guimaraes2020Structure}). Cependant, il
n'existe pas de niveau d'organisation approprié par défaut, car celui-ci dépend
de la question posée (\cite{Niquil2020Shifting}) et des données disponibles.

\subsubsection{Une interaction peut décrire différents processus écologiques} 
...
\subsubsection{Une interaction peut couvrir différentes échelles spatiales} 
