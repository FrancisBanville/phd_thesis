...
\title{Trophique-METE}
\subtitle{Une théorie parcimonieuse de la structure des réseaux trophiques}
...
\codirecteur{Dominique Gravel}         % s'il y a lieu
%%\codirecteurs{Nom du 2e codirecteur} % s'il y a lieu

\membrejury{}

\examinateur{}   %obligatoire pour la these
...
%% etc.
 ...
 % comment faire.
%%\bibliographystyle{amsplain-french}
