...
\title{Quand le lion s'endort: Vers une théorie de l'entropie maximale des réseaux trophiques reposant sur la variabilité des interactions entre espèces}
...
\date{19 août 2024} %Date du DÉPÔT INITIAL (ou du 2e dépôt s'il y a corrections majeures)
...
Pour mieux comprendre le fonctionnement des écosystèmes et mettre en place des
mesures de conservation efficaces, il est essentiel de développer une
compréhension approfondie des interactions entre espèces. Parmi ces
interactions, celles de nature trophique, comme la prédation, l'herbivorie et le
parasitisme, jouent un rôle écologique important en affectant la dynamique des
populations. Cependant, de nombreuses incertitudes subsistent concernant
l'occurrence des interactions trophiques. D'abord, ces incertitudes résultent de
notre manque de connaissances empiriques sur ces interactions et sur les
conditions favorisant leur réalisation. Ensuite, elles découlent de leur
variabilité intrinsèque dans le temps et l'espace. La prise en compte de ces
deux grandes sources d'incertitude (manque de connaissances et variabilité
locale) a conduit plusieurs écologistes à représenter les interactions entre
espèces de manière probabiliste au sein de réseaux écologiques complexes. Dans
cette thèse, je soutiens qu'une telle vision probabiliste des systèmes
écologiques complexes constitue le fondement du principe d'entropie maximale
appliqué aux réseaux trophiques.
...
Le Chapitre 2 présente pourquoi la variabilité locale des interactions
trophiques conduit à des réseaux les plus complexes possible dans la limite d'un
nombre restreint de contraintes écologiques, c'est-à-dire à des réseaux
d'entropie maximale. J'ai développé deux approches (analytique et heuristique)
pour prédire la structure des réseaux trophiques avec le principe d'entropie
maximale. L'approche analytique m'a permis d'obtenir la distribution du nombre
de proies et de prédateurs pour chaque espèce à partir du nombre total d'espèces
et d'interactions dans un réseau local. L'approche heuristique, quant à elle,
m'a permis de trouver que cette même distribution est l'une des contraintes
...
Cette thèse constitue la première étape vers l'élaboration d'une théorie de
l'entropie maximale des réseaux trophiques. Mes résultats démontrent qu'il est
possible de faciliter l'étude des réseaux trophiques en réduisant la quantité
d'informations nécessaires à leur prédiction, tout en mettant en lumière la
simplicité des mécanismes biologiques qui régissent les systèmes écologiques
complexes.
...
measures, it is essential to develop a thorough understanding of species
interactions. Among these interactions, trophic interactions such as predation,
herbivory, and parasitism play a significant ecological role by affecting
...
that such a probabilistic view of complex ecological systems is the
foundation of the principle of maximum entropy applied to food webs.
...
local interactions describing the probability of their occurrence at specific
locations and times, and regional interactions describing the probability of
their biological feasibility. Using a dataset of host-parasite interactions in
...
Chapter 2 presents why local variability in trophic interactions leads to the
most complex networks possible within a limited number of ecological
constraints, i.e. to networks of maximum entropy. I developed two approaches
(analytical and heuristic) to predict food-web structure using the principle of
maximum entropy. The analytical approach allowed me to obtain the distribution
of the number of prey and predators for each species from the total number of
species and interactions in a local network. The heuristic approach, on the
other hand, revealed that this same distribution is one of the primary
ecological constraints determining food-web structure. My models better predict
the structure of aquatic and terrestrial food webs sampled globally than null
models based on the same constraints.

This thesis represents the first step towards developing a maximum entropy
theory of food webs. My results show that we can facilitate the study of food
webs by reducing the amount of information required for their prediction, while
highlighting the simplicity of the biological mechanisms governing complex
ecological systems.
...
Merci à mes collègues de labo et ami-es, Alice Doucet Beaupré, Andrew MacDonald,
Camille Rondeau Saint-Jean, Cole Brookson, Cristian Cruz Rodriguez, Daphnée
Lecours-Tessier, Emily Beasley, Eva Delmas, Gabriel Dansereau, Gracielle Higino,
Kari Norman, Maria Isabel Arce Plata, Mathilde Besson, Mathis Gheno, Michael D.
Catchen, Nerea Montes Perez, Norma Forero-Muñoz, Philippe Desjardins-Proulx,
Salomé Bouskila, Samuel Provencher-Tardif, Tanya Strydom et Valentine Volz. Vous
avez été mes compagnons de voyage, partageant avec moi différents tronçons de
cette excursion qui, sans vous, aurait été bien plus solitaire. 
